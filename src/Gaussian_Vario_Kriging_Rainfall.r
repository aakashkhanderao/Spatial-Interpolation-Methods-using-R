...
model.variog <- vgm(psill=NA, model="Gau", nugget=NA, range=NA) print(fit.variog <- fit.variogram(variog1, model.variog)) plot(variog1, model = fit.variog,pch=20,col="red" ) 
